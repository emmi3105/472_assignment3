...
##### Second query: The average rank of the university across 2003, 2013, and 2023

```{r query for average rank of Ivy Leagues}
# Write the SQL query
second_query <- "
...
##### Third query: The average rank of the university's Economics, Political Science, and Sociology programs, if they were ranked

```{r query for average rank of Economics, Political Sicences, and Sociology programs}
...
##### Fourth query: The current endowment per student (total endowment divided by total number of students), in USD

```{r query for endowment per student}
...
##### Fifth query: The average total revenue per student across the years 2015 - 2020, in USD

```{r average total revenue per student across 2015-2020 in USD}
...
##### Sixth query: The average of the median household income for the County across the years 2015 and 2020, in USD

```{r average median household income for the County across 2015-2020 in USD}
...
# Merge the five dataframes retrieved throgh the sql queries by Institution
...
first_plot <- ggplot(analysis_df, aes(x = Average_Rank, y = Avg_Econ_PolSc_Soc, color = factor(Institution))) +
  ...
  labs(title = "Average Overall Ranking vs Subject Ranking for Ivy League Universities, 2015-2020",
       x = "Average Overall Ranking",
  ...
  scale_x_log10(limits = c(1, 550), expand = c(0.02, 0)) +  # Adjust the limits and expand
  scale_y_log10(limits = c(1, 100), expand = c(0.02, 0))
