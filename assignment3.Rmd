...
```{r get the US states shapefile, message = FALSE, eval = TRUE}
...
```{r create the map plot, message = FALSE, eval=TRUE}
...
geographic_plot <- tm_shape(us_map) +
  tm_polygons("NAME", palette=c("United States"="#8DD08D")) +
  ...
  #tm_dots(size = 0.2, col = custom_colors[geography_sf$Control], title = "University Status") +
  
  # Symbols for Ivy League universities
  tm_shape(geography_sf[geography_sf$Ivy_League == 1, ]) +
  tm_dots(size = 0.1, shape=18, col = "#FF0000", title = "Ivy League") +
  #tm_symbols(shape=18, col = "#FF0000", title = "Ivy League") +
