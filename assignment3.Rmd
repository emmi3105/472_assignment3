...
We write `universities_table` to the relational database `db` under the name `universities_df`. The unique key is the university name, which can be accessed via the `Institution` variable.
